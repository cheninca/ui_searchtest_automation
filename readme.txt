...
1. This is a maven project, Including ui and api test under test folder, please run maven clean install get all the library.
...
3. Run test suite?
   Run maven test. 
(1)	In the Maven tool window, under the Lifecycle node, right-click run, start to run
 
    (2)In command line: mvn test
...
Could be check via your IDE control window,Or check testNG default report, remember you need to add 
